...
class Endpoints:
    def __init__(self, verbose=False):
        ...
        class API:
            ...
            def url_purchased_batches(self, page: int = 1, batch_type: str = "ALL", amount: str = "paid") -> str:
                return f"{self.base}/batch-service/v1/batches/purchased-batches?page={page}&type={batch_type}&amount={amount}"
        ...
        self.data_logs = {
            ...
            "purchased_batches": Lambert[Any](self.API.url_purchased_batches, ["data"], [], raw_return_type=List[Dict[str, Any]]),
    ...
    def get_purchased_batches(self, page: int = 1, batch_type: str = "ALL", amount: str = "paid", all_pages: bool = False, max_pages: int = 20) -> List[Dict[str, Any]]:
        """
        Retrieves purchased batches. If all_pages is True, it paginates until empty or max_pages.
        """
        if not all_pages:
            return self.process(
                type="purchased_batches",
                page=page,
